...
function editTodo(e) {
  ...
  // باز کردن مدال و نمایش متن فعلی TODO در ورودی
  ...
  saveButton.onclick = function () {
    ...
    if (newTitle) {
      todo.title = newTitle;
      saveAllTodos(todos); // ذخیره تغییرات در localStorage
      filterTodos(); // بروزرسانی نمایش TODOها
      modal.style.display = "none"; // بستن مدال بعد از ذخیره
    }
  };
}
